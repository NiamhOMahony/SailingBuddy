...
public class SailingListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder>{
    ...
    public SailingListRecyclerViewAdapter(Context context, List<Sailing> sailingList) {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.sailingHolder.setOnClickListener(new OnClickListener() {
            @Override
        ...
        holder.binButtonImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialogBuilder.setPositiveButton("Yes",
                        (arg0, arg1) -> SailingListRecyclerViewAdapter.this.deleteSailing(itemPosition));
