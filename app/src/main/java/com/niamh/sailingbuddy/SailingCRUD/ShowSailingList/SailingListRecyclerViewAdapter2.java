...
public class SailingListRecyclerViewAdapter2 extends RecyclerView.Adapter<CustomViewHolder>{
    ...
    public SailingListRecyclerViewAdapter2(Context context, List<Sailing> sailingList) {
        this.context = context;
        this.sailingList2 = sailingList;
        this.sailingFilteredData2 =sailingList;
