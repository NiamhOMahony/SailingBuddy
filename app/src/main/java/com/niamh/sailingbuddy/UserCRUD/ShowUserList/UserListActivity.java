...
public class UserListActivity extends AppCompatActivity implements UserCreateListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            adminRecyclerView.setAdapter(userListRecyclerViewAdapter);
            ...
            fab.setOnClickListener(view -> openUserCreateDialog());
         ...
         | BottomNav | Android Coding https://www.youtube.com/watch?v=JjfSjMs0ImQ*/
            ...
            inputSearch.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    userListRecyclerViewAdapter.getNameFilter().filter(s);
                    search = s;
                }
