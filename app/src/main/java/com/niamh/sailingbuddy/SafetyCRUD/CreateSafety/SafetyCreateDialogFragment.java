            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        signOutSpinner.setVisibility(View.GONE);
                        availableTextView.setVisibility(View.GONE);
                        availableTextView.setAnimation(anim_to_right);
                        signOutSpinner.setAnimation(anim_to_right);
                        break;
                    case 1:
                        signOutSpinner.setVisibility(View.VISIBLE);
                        availableTextView.setVisibility(View.VISIBLE);
                        availableTextView.setAnimation(anim_from_right);
                        signOutSpinner.setAnimation(anim_from_right);
                        break;
                }
            }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int i, long l) {
                ...
                switch (i){
                    case 0:
                        ...
                        faultEditText.setVisibility(View.GONE);
                        faultTextView.setVisibility(View.GONE);
                        faultTextView.setAnimation(anim_to_right);
                        signOutFSpinner.setAnimation(anim_to_right);
                        faultEditText.setAnimation(anim_to_left);
                        break;
                    case 1:
                        ...
                        faultTextView.setAnimation(anim_from_right);
                        signOutFSpinner.setAnimation(anim_from_right);
                        faultEditText.setAnimation(anim_from_left);
                        break;
                }
